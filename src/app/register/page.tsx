...
export default function Register() {
    ...
    const handleGoogleSignUp = async () => {
        try {
            ...
            // ✅ Same fix as Login: mirror the cookie session into localStorage
            ...
            <div className="flex items-center justify-center px-6 py-14 sm:px-10">
                ...
                >
                    <Link href="/" className="mb-10 flex items-center gap-2 md:hidden">
                        <span className="flex h-8 w-8 items-center justify-center rounded-full bg-[#C1440E] font-display text-sm font-semibold text-[#F5EFE6]">
                            F
                        </span>
                        <span className="font-display text-lg tracking-tight">Fare</span>
                    </Link>

                    <p className="eyebrow text-[#A8672A]">Join Fare</p>
                    ...
                    <form onSubmit={handleSubmit} className="mt-7 space-y-4">
                        ...
                        <div>
                            ...
                            <input type="password" name="password" required minLength={8} className={inputStyles} />
                        </div>

                        <label className="flex items-start gap-2 pt-1 text-xs text-[#241713]/60">
                            <input
                                type="checkbox"
                                required
                                className="mt-0.5 h-3.5 w-3.5 rounded border-[#241713]/30 text-[#C1440E] focus:ring-[#C1440E]/30"
                            />
                            <span>
                                I agree to Fare's{" "}
                                <Link href="/terms" className="font-semibold text-[#C1440E]">
                                    Terms
                                </Link>{" "}
                                and{" "}
                                <Link href="/privacy" className="font-semibold text-[#C1440E]">
                                    Privacy Policy
                                </Link>
                                .
                            </span>
                        ...
                        <motion.button
                            ...
                            whileHover={registerMutation.isPending ? "rest" : "hover"}
                            initial="rest"
                            animate="rest"
                    ...
                    <button
                        ...
                        className="flex w-full items-center justify-center gap-2 rounded-full border border-[#241713]/15 bg-white/60 py-3 text-sm font-semibold text-[#241713] transition hover:border-[#241713]/30"
                    >
                    ...
                    <p className="mt-7 text-center text-sm text-[#241713]/60">
                        ...
                        <Link href="/login" className="font-semibold text-[#C1440E]">
                            Sign in
                        </Link>
                    </p>
                </motion.div>
